...
export default async function HomePage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const [categories, paymentMethods, recurringRules, installmentPlans, expenses, trendExpenses, upcomingExpenses] = await Promise.all([
  ...
  return (
    <main className="shell">
      ...
      <section className="grid summary-grid" aria-label="Resumo do mês">
